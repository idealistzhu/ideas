...
project-new --named idealistzhu-application-cdbookstore --topLevelPackage org.idealistzhu.application.cdbookstore --finalName applicationCDBookStore ;
...
jpa-new-field --named country --type org.idealistzhu.application.cdbookstore.model.Country --relationshipType Many-to-One ;
# Constraints
...
jpa-new-field --named creditCardType --type org.idealistzhu.application.cdbookstore.model.CreditCardType --columnName credit_card_type ;
...
jpa-new-field --named role --type org.idealistzhu.application.cdbookstore.model.UserRole --columnName user_role ;
...
jpa-new-field --named preferredLanguage --type org.idealistzhu.application.cdbookstore.model.Language --columnName preferred_language ;
...
jpa-new-field --named language --type org.idealistzhu.application.cdbookstore.model.Language ;
# Relationships
# TODO FORGE-2464
jpa-new-field --named category --type org.idealistzhu.application.cdbookstore.model.Category --relationshipType Many-to-One ;
jpa-new-field --named authors --type org.idealistzhu.application.cdbookstore.model.Author --relationshipType One-to-Many ;
jpa-new-field --named publisher --type org.idealistzhu.application.cdbookstore.model.Publisher --relationshipType Many-to-One ;
# Constraints
...
# TODO FORGE-2464
jpa-new-field --named label --type org.idealistzhu.application.cdbookstore.model.Label --relationshipType Many-to-One ;
jpa-new-field --named musicians --type org.idealistzhu.application.cdbookstore.model.Musician --relationshipType Many-to-Many ;
jpa-new-field --named genre --type org.idealistzhu.application.cdbookstore.model.Genre --relationshipType Many-to-One ;


#  Musician Entity
#  ############
cd ../Musician.java ;
jpa-new-field --named cds --type org.idealistzhu.application.cdbookstore.model.CD --relationshipType Many-to-Many ;
...
# Relationships
jpa-new-field --named item --type org.idealistzhu.application.cdbookstore.model.Item --relationshipType Many-to-One --cascadeType PERSIST ;
# Constraints
...
# Relationships
# TODO FORGE-2466
jpa-new-field --named customer --type org.idealistzhu.application.cdbookstore.model.User --relationshipType Many-to-One ;
jpa-new-field --named orderLines --type org.idealistzhu.application.cdbookstore.model.OrderLine --relationshipType One-to-Many ;
# Constraints
...
#  ############
# TODO FORGE-2464
java-new-package --named org.idealistzhu.application.cdbookstore.model --createPackageInfo ;
...
cdi-new-interceptor --named LoggingInterceptor --interceptorBinding org.idealistzhu.application.cdbookstore.util.Loggable --targetPackage ~.util ;
...
cdi-new-interceptor --named CatchExceptionInterceptor --interceptorBinding org.idealistzhu.application.cdbookstore.view.util.CatchException  --targetPackage ~.view.util ;
cdi-add-injection-point --named logger --type java.util.logging.Logger ;
...
#  ############
# TODO FORGE-2466
cdi-new-bean --named IsbnGenerator --qualifier org.idealistzhu.application.cdbookstore.util.ThirteenDigits --targetPackage ~.util ;
cdi-add-injection-point --named logger --type java.util.logging.Logger ;
# TODO FORGE-2466
cdi-add-injection-point --named prefix --type String --qualifiers org.idealistzhu.application.cdbookstore.util.ThirteenDigits ;
cdi-add-injection-point --named postfix --type int --qualifiers org.idealistzhu.application.cdbookstore.util.ThirteenDigits ;
# TODO Implement interface
java-new-method --methodName generateNumber --returnType String --accessType public ;

#  IssnGenerator
#  ############
cdi-new-bean --named IssnGenerator --qualifier org.idealistzhu.application.cdbookstore.util.EightDigits --targetPackage ~.util ;
cdi-add-injection-point --named logger --type java.util.logging.Logger ;
# TODO FORGE-2466
cdi-add-injection-point --named prefix --type String --qualifiers org.idealistzhu.application.cdbookstore.util.EightDigits ;
cdi-add-injection-point --named postfix --type int --qualifiers org.idealistzhu.application.cdbookstore.util.EightDigits ;
# TODO Implement interface
java-new-method --methodName generateNumber --returnType String --accessType public ;
...
#  Number producer
#  ############
java-new-class --named NumberProducer --targetPackage org.idealistzhu.application.cdbookstore.util ;
# TODO producers
...
java-add-annotation --annotation org.idealistzhu.application.cdbookstore.util.ThirteenDigits --onProperty prefix1 ;
...
java-add-annotation --annotation org.idealistzhu.application.cdbookstore.util.ThirteenDigits --onProperty postfix1 ;
...
java-add-annotation --annotation org.idealistzhu.application.cdbookstore.util.EightDigits --onProperty prefix2 ;
...
java-add-annotation --annotation org.idealistzhu.application.cdbookstore.util.EightDigits --onProperty postfix2 ;
...
java-add-annotation --annotation org.idealistzhu.application.cdbookstore.util.ThirteenDigits --onProperty prefix3 ;
java-add-annotation --annotation org.idealistzhu.application.cdbookstore.util.EightDigits --onProperty prefix3 ;
...
java-add-annotation --annotation org.idealistzhu.application.cdbookstore.util.ThirteenDigits --onProperty postfix3 ;
java-add-annotation --annotation org.idealistzhu.application.cdbookstore.util.EightDigits --onProperty postfix3 ;
...
java-add-annotation --annotation org.idealistzhu.application.cdbookstore.util.Vat --onProperty vatRate ;
...
java-add-annotation --annotation org.idealistzhu.application.cdbookstore.util.Discount --onProperty discountRate ;
...
# TODO ~ 
scaffold-generate --provider Faces --webRoot /admin --targets org.idealistzhu.application.cdbookstore.model.* ;
...
# TODO ~
rest-generate-endpoints-from-entities --contentType application/xml application/json --targets org.idealistzhu.application.cdbookstore.model.CD ;
rest-generate-endpoints-from-entities --contentType application/xml application/json --targets org.idealistzhu.application.cdbookstore.model.Book ;
...
# TODO ~
arquillian-create-test --enableJPA --targets org.idealistzhu.application.cdbookstore.view.* ;
...
# TODO ~
arquillian-create-test --enableJPA --targets org.idealistzhu.application.cdbookstore.rest.* ;
